...
def member_articles(cat=None):
    return render_template('/Articles/Member_Only/memberarticle.html', title='Member Articles')

@main.route('/welcome_member', methods=['GET', 'POST'])
def welcome_member(cat=None):
    return render_template('/Articles/Member_Only/posts/memberwelcome.html', title='Welcome Member')
#Trainers
